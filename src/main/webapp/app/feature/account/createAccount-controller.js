...
(function() {
    ...
    var CreateAccountController =  function(accountService, $log) {
    ...
    angular.module('accountApp').controller('createAccountController', ['accountService','$log', CreateAccountController]);
}());